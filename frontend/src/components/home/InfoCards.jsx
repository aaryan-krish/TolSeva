...
const cards = [
  { icon: Scale, title: 'Legal Metrology Act, 2009', desc: 'Regulates weights, measures, and measuring instruments to ensure accuracy, fairness, and consumer protection across India.', color: 'bg-blue-50 text-saffron-600', border: 'border-saffron-200' },
  { icon: FileCheck, title: 'Instrument Verification', desc: 'All commercial weighing and measuring instruments must be verified and stamped by authorized Legal Metrology inspectors before use.', color: 'bg-green-50 text-indiaGreen', border: 'border-green-200' },
    ...
    <section id='about' className='py-16 bg-gray-50'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-10'>
          <span className='inline-block bg-saffron-100 text-saffron-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-3'>About the Platform</span>
          <h2 className='text-3xl font-extrabold text-saffron-600'>Legal Metrology at a Glance</h2>
