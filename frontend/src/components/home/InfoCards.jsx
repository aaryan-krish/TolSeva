...
const cards = [
  { icon: Scale, title: 'Legal Metrology Act, 2009', desc: 'Regulates weights, measures, and measuring instruments to ensure accuracy, fairness, and consumer protection across India.', color: 'bg-blue-50 text-navy-900', border: 'border-navy-200' },
    ...
    <section id='about' className='py-16 bg-gray-50'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-10'>
          <span className='inline-block bg-navy-100 text-navy-900 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-3'>About the Platform</span>
          <h2 className='text-3xl font-extrabold text-navy-900'>Legal Metrology at a Glance</h2>
