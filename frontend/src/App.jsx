        ...
        <Router>
          ...
          <footer className="bg-emerald-600 text-white py-8">
            <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-6 text-sm">
              <div>
                <h4 className="font-bold text-orange-500 mb-2">TolSeva</h4>
                <p className="text-gray-300">Unified Online Verification &amp; Certification Platform for Legal Metrology</p>
              </div>
              <div>
                <h4 className="font-bold text-orange-500 mb-2">Quick Links</h4>
              ...
              <div>
                <h4 className="font-bold text-orange-500 mb-2">Helpline</h4>
