...
export default function VendorHomeScreen() {
  ...
  const [newMachine, setNewMachine] = useState({
    ...
    capacity: '', unit: 'kg', manufacture_year: '2024'
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={{ flex: 1 }}>
          <Text style={styles.headerRole}>🏪 VENDOR DASHBOARD</Text>
      ...
      {expiredCount > 0 && (
        <View style={styles.alertBanner}>
          <Text style={styles.alertText}>
            ⚠️ {expiredCount} instrument(s) expired! Book renewal immediately.
          </Text>
        </View>
      )}
      ...
      {loading ? (
              ...
              <View style={styles.card}>
                ...
                <View style={styles.btnRow}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setNewAppt(a => ({ ...a, instrument_id: item.id }));
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <TouchableOpacity
              style={[styles.actionAddBtn, { backgroundColor: '#0d9488' }]}
...
const styles = StyleSheet.create({
  ...
  headerRole: { color: GOLD, fontSize: 11, fontWeight: 'bold', letterSpacing: 1 },
  bizName: { color: '#fff', fontSize: 18, fontWeight: 'bold', marginTop: 2 },
  gstinText: { color: '#c5d8f6', fontSize: 12, marginTop: 1 },
  logoutBtn: { backgroundColor: 'rgba(255,255,255,0.18)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)' },
  ...
  actionAddBtn: { backgroundColor: NAVY, borderRadius: 10, paddingVertical: 12, alignItems: 'center', marginBottom: 12 },
  ...
  machineTitle: { fontSize: 16, fontWeight: 'bold', color: NAVY },
  ...
  renewBtnText: { color: '#15803d', fontSize: 12, fontWeight: 'bold' },
  ...
  modalTitle: { fontSize: 18, fontWeight: 'bold', color: NAVY, marginBottom: 14 },
  ...
  submitModalBtn: { flex: 1, backgroundColor: NAVY, paddingVertical: 11, borderRadius: 8, alignItems: 'center' },
